...
class Reservation extends Model
{
    ...
    protected $fillable = ['user_id', 'washing_machine_id', 'reservation_date', 'reservation_time', 'weight_kg', 'status', 'notes', 'cancelled_at'];
    ...
    {
        return Carbon::parse($this->reservation_date->toDateString().' '.$this->reservation_time)->isPast();
    }
}
